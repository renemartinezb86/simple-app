package com.aws.java.repository;

import com.aws.java.SimpleApp;
import com.aws.java.config.Constants;
import com.aws.java.config.audit.AuditEventConverter;
import com.aws.java.domain.PersistentAuditEvent;
...
import static com.aws.java.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
